...
static std::unordered_map<std::string, USBKeyDefinition> keyLookupTable = {
    ...
    {WINDOWS, USBKeyDefinition(USBKeyDefinition::UsbHidModifiers::LeftGui)},
    {COMMAND, USBKeyDefinition(USBKeyDefinition::UsbHidModifiers::LeftGui)},
    {END, USBKeyDefinition(0x4d)},
    {UPARROW, USBKeyDefinition(0x52)},
    {DOWNARROW, USBKeyDefinition(0x51)},
    {LEFTARROW, USBKeyDefinition(0x50)},
    {RIGHTARROW, USBKeyDefinition(0x4f)},
    {PAGEUP, USBKeyDefinition(0x4b)},
